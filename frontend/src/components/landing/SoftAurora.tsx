...
export default function SoftAurora({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uEnableMouse: { value: enableMouseInteraction && !prefersReducedMotion },
      },
    });
    ...
    const renderFrame = (time: number) => {
      ...
      if (enableMouseInteraction && !prefersReducedMotion) {
        currentMouse = [
  ...
  return <div ref={containerRef} aria-hidden className={['soft-aurora-container', className].filter(Boolean).join(' ')} />;
}
